...
{	
	...
	function Header()
	{
	    ...
	    $this->cell(50,7,"Name",1,0,'C',true);
	    $this->cell(25,7,"Branch",1,0,'C',true);
		$this->cell(25,7,"Semester",1,0,'C',true);
		$this->cell(25,7,"Library",1,0,'C',true);
		$this->cell(20,7,"In",1,0,'C',true);
		$this->cell(20,7,"Out",1,1,'C',true);


		$conn=mysqli_connect("localhost","id11804649_zaid","123456","id11804649_library_system");
		$date=date("Y-m-d");
		$s="select library.stud_id, stud_firstname,branch,selectedlibrary,semester,checked_in,checked_out from student1,library where  student1.stud_id=library.stud_id AND date='$date order by checked_in'";
	    ...
	    $this->cell(50,5,$row['stud_firstname'],1,0,'C',true);
	    $this->cell(25,5,$row['branch'],1,0,'C',true);
		$this->cell(25,5,$row['semester'],1,0,'C',true);
		$this->cell(25,5,$row['selectedlibrary'],1,0,'C',true);	
